...
// GetMe returns the authenticated user's profile, looked up via the JWT
// the auth middleware put into the request context. Used by the React
// app to verify a stored token on page load.
